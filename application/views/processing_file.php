...
<section class="section-ln">
	...
	<div class="content-container">
		<p><span class="note">Please be patient. We are now pre-processing your ride data into a format where it can be retrieved and read quickly and efficiently.<br>If file processing <em>fails</em>, sign out and back in again - some browsers do not store persistent cookies correctly under some circumstances. If this solves the issue, <em>don't</em> choose the remember me option at sign in.</span></p>
		<div id="parse-window">
