                ...
                <section>
                    <article class="the-blurb">
                        <div class="col-1-2">
                            ...
                            <p><span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span> is a tool targeted at racing cyclists - especially  those participating in time trials or other forms of bicycle racing. I developed <span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span> because I felt there wasn&rsquo;t a tool out there  that gave me high quality feedback, particularly my response to various  training protocols, for which I have very limited time.</p>
                            <p>It was clear that although other software products I&rsquo;d  tried or bought offer some a degree of efficacy, none of them quite met my needs. So with a background in cycling, computer programming and analytical databases  and with a window of opportunity I figured - go build one.</p>
                            <h3>Simple to use</h3>
                            ...
                            <ol>
                              ...
                              <li>there are tools that do this very well already,  notably Strava. As Strava offer an API which allows connectivity with external  apps.  Although <span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span> doesn&rsquo;t  show data normally only associated with outdoor only rides, it does send it to  Strava. </li>
                            ...
                            <p>Having lots of configurable charts is great, but it takes  considerable knowledge to interpret the data, and feedforward that information  to make real performance gains. I&rsquo;ve read most of the books out there on  the subject of cycling performance and training, but I still feel that none of  the prescribed methodologies quite fits my own unique body, in fact - the more  I read, the slower I became. I&rsquo;m a believer that everyone is  different and responds quite differently to various stimuli - I know for  instance, that I struggle to recover at the rate suggested by most training  plans - usually resulting in overtraining. That is why I created the  <span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span> performance chart. The tool shows correlations between heart  rate and power - so you <em>do </em>need a power measuring tool of some sort.  Originally this chart plotted average heart rate against average power, useful  to know, but a bit limited. I&rsquo;m always trying to find new ways to  refine and improve <span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span>, and so added:</p>
                            <ol>
                              <li>average  cadence to show correlations between cadence and power over time </li>
                              <li>notable  performance indicators. This is at the heart of the <span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span> system - it  looks at the Critical Power (CP) for the ride (user selected filter e.g. CP20)  and compares with previous rides. Riders can choose how notable a performance  needs to be before the icon is displayed from their settings. Increasing CP is  good news, and even better if indicated by a lower heart rate for the same  period. </li>
                              <li>a  series of advanced filters was included allowing the rider to compare like for  like performances including the rides duration, whether it was indoors or  outdoors, and whether or not it was a competitive ride. This makes it far  easier to visualise genuine trends in performance. Another filter allows a  quick comparison or a previous period of equal duration. </li>
                            ...
                            <p>Since implementing the latest version of the performance chart,  my own performance (20Minute CP) is starting to improve. The Performance Chart  enables me - in a relatively short space of time - to test out the efficacy of  different training strategies. You can view my data in the demo, but please don&rsquo;t  laugh <em>too</em> loudly at my power figures…</p>
                            <h3>Training Impact</h3>
                            <p><span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span> has a graphical display of fitness and fatigue  (CTL, ATL and TSB) similar to that found on many other systems. If you have a  power meter fail, or ride without a power meter sometimes then either the  training load is calculated from heart rate or you can add your own value.  Rider set value takes precedence over power based value which in turn takes  precedence over any heart rate based value. When saving an activity the rider  can set the motivation level and perceived effort for the ride, and this is  plotted against the training load chart data. There is scope for doing  something rather more useful with this data at some point in the future.</p>
                        </div>
                        <div class="col-1-2">
                            <h3>Quick view  Dashboard</h3>
                            <p>Often I just want to view how much riding I&rsquo;ve  done for the week so far, and of what type. The Dashboard gives a quick glance  view of accrued training load and duration, current form, fitness and fatigue,  and cumulative time recorded in each heart rate and power zone.</p>
                            <h3>Other useful data</h3>
                            <p><span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span> already has a range of graphs for historical  analysis including</p>
                            <ol>
                              <li>Mean  Maximal Power chart - allowing riders to view the selected period against the  two previous periods and when the best performances were recorded </li>
                              <li>Training  Load vs Duration, plots weekly (or monthly when more than 366 days selected). </li>
                              <li>Heart  rate by Zone and Power by Zone charts allow weekly/monthly (as above) breakdown  of time in zones, I want to create user settable zones at some point soon - for  now they are based on popular calculations from threshold power and heart rate  values. </li>
                            </ol>
                            ...
                            <h3>Socialising</h3>
                            <p>Many successful apps are such because they are social. I haven&rsquo;t  decided if a social feature - perhaps CP/Kg leaderboards or other social  features would useful or whether they would detract from the core  functionality.</p>
                            <h3>Bugs and new  features / feature requests</h3>
                            <p>It&rsquo;s difficult choosing devoting time  between testing existing functionality, and adding new features (which can often  introduce new issues), but I try to get that balance as near as I can. If you  do find issues, please let me know as I want to know about them! It would be  great to hear rider&rsquo;s requests for new features - every  rider has different requirements and it would make sense to incorporate as many  of these as I can! <br />
