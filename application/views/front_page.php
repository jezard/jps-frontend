			...
			<article class="blurb">
				...
				<div class="col-1-2">
					...
					<div class="content-container" style="background-image: url(<?php echo $this->config->item('base_url'); ?>/images/background-icons/objectives.png)" >
						...
						<p><span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span> provides you as a cyclist with some very useful features – there’s a lot to do before we can begin to say we’re finished – we’d like your input – what are your requirements for perfect cycling analytics? Tell us <a href="/index.php/forum">here</a>. Popular requests are likely candidates for early implementation to <span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span>. <span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span> is a tool for Cyclists, made by Cyclists. We read the forums and it confirmed our feelings that there must be a better way. That is why we created <span class="jps-em"><span>Joule</span><span>Per</span><span>Second</span></span>.</p>
